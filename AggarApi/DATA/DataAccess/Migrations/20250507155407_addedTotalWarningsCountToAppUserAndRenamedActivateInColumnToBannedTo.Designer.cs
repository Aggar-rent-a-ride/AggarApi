...
namespace DATA.DataAccess.Migrations
{
    ...
    [Migration("20250507155407_addedTotalWarningsCountToAppUserAndRenamedActivateInColumnToBannedTo")]
    partial class addedTotalWarningsCountToAppUserAndRenamedActivateInColumnToBannedTo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DATA.Models.Notification", b =>
                {
                    ...
                    b.HasIndex("TargetBookingId")
                        .IsUnique()
                        .HasFilter("[TargetBookingId] IS NOT NULL");

                    b.HasIndex("TargetCustomerReviewId")
                        .IsUnique()
                        .HasFilter("[TargetCustomerReviewId] IS NOT NULL");

                    b.HasIndex("TargetMessageId")
                        .IsUnique()
                        .HasFilter("[TargetMessageId] IS NOT NULL");

                    b.HasIndex("TargetRentalId")
                        .IsUnique()
                        .HasFilter("[TargetRentalId] IS NOT NULL");

                    b.HasIndex("TargetRenterReviewId")
                        .IsUnique()
                        .HasFilter("[TargetRenterReviewId] IS NOT NULL");
            ...
            modelBuilder.Entity("DATA.Models.Notification", b =>
                {
                    ...
                    b.HasOne("DATA.Models.Booking", "TargetBooking")
                        ...
                        .HasForeignKey("DATA.Models.Notification", "TargetBookingId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DATA.Models.CustomerReview", "TargetCustomerReview")
                        .WithOne("Notification")
                        .HasForeignKey("DATA.Models.Notification", "TargetCustomerReviewId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DATA.Models.Message", "TargetMessage")
                        .WithOne("Notification")
                        .HasForeignKey("DATA.Models.Notification", "TargetMessageId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DATA.Models.Rental", "TargetRental")
                        .WithOne("Notification")
                        .HasForeignKey("DATA.Models.Notification", "TargetRentalId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DATA.Models.RenterReview", "TargetRenterReview")
                        .WithOne("Notification")
                        .HasForeignKey("DATA.Models.Notification", "TargetRenterReviewId")
                        .OnDelete(DeleteBehavior.NoAction);
